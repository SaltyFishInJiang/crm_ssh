					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<tr>
								<td>联系人性别：</td>
								<td>
								<label for="male">男</label><input id="male" type="radio" name="lkm_gender"  value="男">
								<label for="female">女</label><input id="female" type="radio" name="lkm_gender" value="女">
								</td>
							</TR>
