...
<script type="text/javascript">
	function change() {
		...
		img.src = "${pageContext.request.contextPath}/user_verfiy.action?time="
				+ new Date().getTime();
	}
</script>
</HEAD>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtcode 
                  style="WIDTH: 130px" name="verfiyCode"></TD>
                <TD style="HEIGHT: 28px"><a href="javascript:change()"><img id="img" src="${pageContext.request.contextPath}/user_verfiy.action" border="1px" /></a></TD></TR>
              <TR>
                <TD style="HEIGHT: 18px"></TD>
                <TD style="HEIGHT: 18px"><span style="color: maroon;">${requestScope.error}</span></TD>
